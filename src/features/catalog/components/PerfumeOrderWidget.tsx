      ...
      <div className="mt-6">
        {esDisponible ? (
          <a
            ...
            className="flex w-full items-center justify-center gap-3 rounded-xl bg-gradient-to-r from-gold via-gold-mid to-gold-light py-4 text-sm font-bold text-black transition-all duration-300 hover:shadow-gold-glow-lg hover:opacity-95"
          >
